...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments) -> None:
    ...
    llm = OpenAIResponsesLLMService(
        ...
        settings=OpenAIResponsesLLMService.Settings(
            ...
            system_instruction="You are Habi Friend, a kind and concise voice companion for a habit-building app. Your responses will be spoken aloud, so avoid emojis, bullet points, or formatting that cannot be spoken. Respond briefly and help the user take one practical next step.",
        ),
    )
