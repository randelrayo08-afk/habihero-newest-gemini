extends Control
# Privacy Signup Navigation - Manages privacy screen during signup process
...
func _ready() -> void:
	...
	_checkbox = get_node_or_null("Panel4/CheckBox") as CheckBox
	_agree_button = get_node_or_null("Panel4/Button2") as Button
...
func _on_agree_pressed() -> void:
	"""User agreed to privacy policy, then return to signup."""
