...
const UvCacheCleanup := preload("res://animations-1/addons/godot_ai/utils/uv_cache_cleanup.gd")
const ClientConfigurator := preload("res://animations-1/addons/godot_ai/client_configurator.gd")
const PortResolver := preload("res://animations-1/addons/godot_ai/utils/port_resolver.gd")
const WindowsPortReservation := preload("res://animations-1/addons/godot_ai/utils/windows_port_reservation.gd")
const McpServerStateScript := preload("res://animations-1/addons/godot_ai/utils/mcp_server_state.gd")
const McpStartupPathScript := preload("res://animations-1/addons/godot_ai/utils/mcp_startup_path.gd")
const McpAdoptionLabelScript := preload("res://animations-1/addons/godot_ai/utils/mcp_adoption_label.gd")
const McpServerVersionCheckScript := preload("res://animations-1/addons/godot_ai/utils/server_version_check.gd")
